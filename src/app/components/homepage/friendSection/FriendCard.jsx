...
const FriendCard = ({ friend }) => {
  return (
    <Link
      ...
      className="bg-white shadow-md rounded-lg text-center p-6 flex flex-col justify-center items-center transition-all duration-300 hover:scale-103 hover:shadow-xl"
    >
      <Image
        src={friend.picture}
        alt={friend.name}
